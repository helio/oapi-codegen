...
func (t *Test_FieldA) prepareTestFieldA0(v TestFieldA0) ([]byte, error) {
...
func (t *Test_FieldA) prepareTestFieldA1(v TestFieldA1) ([]byte, error) {
	return json.Marshal(v)
}
...
func (t *Test_FieldC) prepareTestFieldC0(v TestFieldC0) ([]byte, error) {
	return json.Marshal(v)
}
...
func (t *Test_FieldC) prepareTestFieldC1(v TestFieldC1) ([]byte, error) {
	return json.Marshal(v)
}
