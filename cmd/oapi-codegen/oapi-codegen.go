...
import (
	...
	"github.com/helio/oapi-codegen/v2/pkg/codegen"
	"github.com/helio/oapi-codegen/v2/pkg/util"
)
...
func main() {
	...
	if strings.HasPrefix(swagger.OpenAPI, "3.1.") {
		fmt.Println("WARNING: You are using an OpenAPI 3.1.x specification, which is not yet supported by oapi-codegen (https://github.com/helio/oapi-codegen/issues/373) and so some functionality may not be available. Until oapi-codegen supports OpenAPI 3.1, it is recommended to downgrade your spec to 3.0.x")
	}
